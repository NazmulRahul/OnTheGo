...
const UserProfile = () => {
  return (
    <div className='h-full w-[30%] fixed flex flex-col justify-start items-center pt-[30px] gap-3 '>
      ...
      <section className='w-[80%] h-[360px] overflow-y-scroll bg-gray-900 text-whiteflex flex-col items-center justify-start gap-2'>
               <div className=''>
                <p className='text-3xl font-semibold'>Visit your trips</p>
                <button className='w-[200px] h-[30px] rounded-2xl shadow-xl text-lg mt-2 font-medium hover:text-black hover:bg-white'>Plan new trip</button>
               </div>
